...
public class EDCLeadSearch {
	...
	public static void main(String[] args) throws InterruptedException {
	        ...
	        //************Start Test Case 3, Open The customer*********************//
	       ...
	       //quick.moveToElement(driver.findElement(By.className("react-grid-Cell__value"))).perform();
	       
	       JavascriptExecutor js = (JavascriptExecutor) driver;
	       js.executeScript("window.scrollBy(0,250)", "");
	       
	       driver.findElement(By.xpath("//a[contains(@data-autoid,'CRMNEXT Lead ID_0')]")).click();//Clicking on Lead
	       Thread.sleep(5000);
	       //**************End Test Case 3******************//
