 ...
 *
 */
public class EtbJourney_G5 implements Properties
{
	...
	//	driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
       ...
       // driver.findElement(By.xpath("//*[@id=\\\"newobject\\\"]/div[3]/div[2]/div[2]/div/a[1]/i")).click();
        ...
        while(anotherchildwindow.hasNext())
        {
        	...
        	if(!(secondMainWindow).equalsIgnoreCase(childsec))
        		...
        		WebElement startETblead=driver.findElement(By.xpath("//a[@class='screenFlowJnry__item-link' and @id='1']"));
        				startETblead.click();
        ...
        WebElement IgnoreandCreateButton=driver.findElement(By.xpath("//button[text()='Ignore and Create']"));
        ...
        driver.findElement(By.xpath("//div[contains(@class,'fixed-stack-button')]")).click();
        System.out.println("Clicked on Custom Action Button in Lead Detail Page");
        
        driver.findElement(By.xpath("//div[contains(@class,'overlay-button')]//child::a//child::i[@class='icon icon-edit']")).click();
      ...
      //  driver.findElement(By.xpath(IssoleOwner)).click();
       ...
       // WebElement clickPerformCRRSC=driver.findElement(By.xpath("//div[contains(@class,'overlay-button-list')]//child::a[@title='Perform CRRSC']//child::i']"));
        WebElement clickPerformCRRSC=driver.findElement(By.xpath(" //div[@class='overlay-button-list']//i[@class='icon icon icon-screenflow']"));
      ...
      System.out.println("Entered remarks of CRRSC");
       ...
       driver.findElement(By.xpath("//a[@class='tb button-icon-text f5 ']")).click();
...
//       driver.findElement(By.xpath("//div[@class='overlay-button-list list-scroll']//child::a[@title='Fill Account Information']")).click();
       driver.findElement(By.xpath("//div[contains(@class,'overlay-button-list')]//child::a//child::i[@class='icon icon icon-screenflow']")).click();
