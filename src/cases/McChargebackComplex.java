...
public class McChargebackComplex implements Properties {
	...
	@Test(priority=1)
	public void Digibanker() throws InterruptedException, IOException, AWTException
	{
...
//   driver.switchTo().window(mainWindowHandle);
   wait.until(ExpectedConditions.presenceOfElementLocated(By.name("CASE_SUBCATEGORY1")));
     ...
     SUBCategroy.sendKeys("Mc Chargeback - Goods/Service Not Rendered");
     Thread.sleep(1000);
     ...
     Complaintcategory.sendKeys("Complex");
     Thread.sleep(1000);
   ...
   //  driver.navigate().refresh();
    ...
    driver.findElement(By.xpath("//div[contains(@class,'file-selector')]")).click();
    ...
    StringSelection str = new StringSelection("D:\\SBC\\GOLD 7\\CRS\\Call Center Layout Enhancement\\Execution & Pots\\POts\\screenshot.1.jpg");
