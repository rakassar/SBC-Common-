...
public class Linking_UnlinkingOfAccountToCustomer implements Properties
{
...
//      
   ...
   wait.until(ExpectedConditions.presenceOfElementLocated(By.name("CASE_SUBCATEGORY1")));
     ...
     Thread.sleep(1000);
     SUBCategroy.sendKeys("Linking/Unlinking of Account to Customer"); //Enter SSC
     Thread.sleep(1000);
...
//     this is for account selection
     ...
     Thread.sleep(1000);
     driver.findElement(By.xpath("//input[@name='Grid_SearchTextBox']")).sendKeys("EAN122469"); // Selecting account 
     Thread.sleep(1000);
   //  driver.findElement(By.xpath("//i[@class='icon icon-arrow-right2']")).click();
     driver.findElement(By.xpath("//div[@title='EAN122469']")).click();
     Thread.sleep(2000);
   ...
   //  driver.navigate().refresh();
    ...
    // Select Parent/ BBN/ EQBN / To Be Linked
    
    driver.findElement(By.xpath("//*[@id=\"newobject\"]/div/div[2]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div[98]/div[1]/div/div/div/div/a")).click();
    Thread.sleep(2000);
    driver.findElement(By.xpath("//input[@name='Grid_SearchTextBox']")).sendKeys("38000000911");
    Thread.sleep(2000);
    driver.findElement(By.xpath("/html/body/div[3]/div/div/div/div/div/div/div/div/div/div[1]/div/div[1]/div/div[2]/a")).click();
    Thread.sleep(1000);
    driver.findElement(By.xpath("/html/body/div[3]/div/div/div/div/div/div/div/div/div/div[2]/div[1]/div/div/div[2]/div/div/div[2]/div/div/div[1]/div/div/span/div")).click();
    
    
  //Select Action Required drop down
    Thread.sleep(1000);
    driver.findElement(By.xpath("//select[@name='cust_1961']")).click();
     WebElement ddown11 = driver.findElement(By.xpath("//select[@name='cust_1961']")); // Select Type of Request drop down
     Select SM11 = new Select(ddown11);
     SM11.selectByVisibleText("Linking");
     Thread.sleep(1000);
     
     //Select Relationship Type drop down
     driver.findElement(By.xpath("//select[@name='cust_2026']")).click();
      WebElement ddown12 = driver.findElement(By.xpath("//select[@name='cust_2026']")); // Select Type of Request drop down
      Select SM12 = new Select(ddown12);
      SM12.selectByVisibleText("And");
      Thread.sleep(1000);
