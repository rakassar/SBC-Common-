...
public class ContactInformation_ByCCA implements Properties
{
...
//      
   ...
   wait.until(ExpectedConditions.presenceOfElementLocated(By.name("CASE_SUBCATEGORY1")));
     ...
     SUBCategroy.sendKeys("Contact Information"); //Enter SSC
     Thread.sleep(1000);
   ...
   //  driver.findElement(By.xpath("//i[@class='icon icon-arrow-right2']")).click();
     ...
     Thread.sleep(1000);
     driver.findElement(By.xpath("//select[@name='cust_114']")).click();
     WebElement ddown12 = driver.findElement(By.xpath("//select[@name='cust_1673']")); // Select Action Type drop down
     Select SM12 = new Select(ddown12);
     SM12.selectByVisibleText("Contact Maintenance");
     Thread.sleep(1000);
     driver.findElement(By.xpath("//a[@data-autoid='cust_722_srch']")).click(); //Click on product field
     driver.findElement(By.xpath("//input[@name='Grid_SearchTextBox']")).sendKeys("Permanent Address");
     driver.findElement(By.xpath("//i[@class='icon icon-arrow-right2']")).click(); 
     Thread.sleep(1000);
