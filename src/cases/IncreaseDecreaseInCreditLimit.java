...
public class IncreaseDecreaseInCreditLimit implements Properties
{
...
//      
   ...
   wait.until(ExpectedConditions.presenceOfElementLocated(By.name("CASE_SUBCATEGORY1")));
     ...
     SUBCategroy.sendKeys("Increase/Decrease In Credit Limit");
     Thread.sleep(1000);
     ...
     Thread.sleep(1000);
     driver.findElement(By.xpath("//input[@name='Grid_SearchTextBox']")).sendKeys("190052193"); // Selecting account 
     Thread.sleep(1000);
   //  driver.findElement(By.xpath("//i[@class='icon icon-arrow-right2']")).click();
     driver.findElement(By.xpath("//div[@title='190052193']")).click();
     Thread.sleep(1000);
   ...
   //  driver.navigate().refresh();
    ...
    Thread.sleep(1000);
    WebElement ddown1 = driver.findElement(By.xpath("//select[@name='cust_2575']")); // Select INCREASE/DECREASE IN CREDIT LIMIT in drop down
    Select SM1 = new Select(ddown1);
    SM1.selectByVisibleText("PERMANENT INCREASE/ DECREASE IN CREDIT LIMIT - SUPPLE & E-SECURE");
   ...
   driver.findElement(By.xpath("//input[@name='cust_1962']")).sendKeys("660000"); // Input data in New Limit text field
   Thread.sleep(1000);
   
   
   
   Thread.sleep(1000);
   driver.findElement(By.xpath("//*[@id=\"newobject\"]/div/div[2]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div[166]/div[1]/div/div/div/div/input")).click(); // Select Start Date
   driver.findElement(By.xpath("//*[@id=\"newobject\"]/div/div[2]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div[166]/div[1]/div/div/div/div/input")).sendKeys("10/24/2022"); // Enter Start Date
   Thread.sleep(1000);
   
   Thread.sleep(1000);
   driver.findElement(By.xpath("//*[@id=\"newobject\"]/div/div[2]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div[166]/div[2]/div/div/div/div/input")).click(); // Select End Date
   driver.findElement(By.xpath("//*[@id=\"newobject\"]/div/div[2]/div/div/div/div/div[2]/div/div[3]/div/div[2]/div[166]/div[2]/div/div/div/div/input")).sendKeys("11/24/2022"); // Enter End Date
   Thread.sleep(1000);
   
   WebElement ddown2 = driver.findElement(By.xpath("//select[@name='cust_1893']")); // Select Credit Limit Request Type in drop down
   Select SM2 = new Select(ddown2);
   SM2.selectByVisibleText("Increase in Credit Limit - eSecure");
   
   Thread.sleep(1000);
   WebElement ddown3 = driver.findElement(By.xpath("//select[@name='cust_1965']")); // Select Update Type in drop down
   Select SM3 = new Select(ddown3);
   SM3.selectByVisibleText("Permanent");
   
   Thread.sleep(1000);
   WebElement ddown4 = driver.findElement(By.xpath("//select[@name='cust_1987']")); // Select Process Type in drop down
   Select SM4 = new Select(ddown4);
   SM4.selectByVisibleText("Increase");
   ...
   // Record send to on Cards - AMD - Processor	   
    
	driver.findElement(By.id("TxtName")).sendKeys("210753"); //loginid
