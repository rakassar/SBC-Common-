...
public class CopyOfOtherLoanRelatedDocuments implements Properties
{
	...
	{
	//	String URL="https://sbcdev.crmnext.com/sag7/app/login/login";
...
//      
   ...
   wait.until(ExpectedConditions.presenceOfElementLocated(By.name("CASE_SUBCATEGORY1")));
     ...
     SUBCategroy.sendKeys("Copy Of Other Loan Related Documents"); //Enter SSC
     Thread.sleep(2000);
   ...
   //  driver.navigate().refresh();
    ...
    //Selecting Type of Document picker field
    driver.findElement(By.xpath("//div[87]//div[2]//div[1]//div[1]//div[1]//div[1]//a[1]//i[1]")).click();
    driver.findElement(By.xpath("//input[contains(@name,'Grid_SearchTextBox')]")).sendKeys("Copy of Deed of Sale");
    Thread.sleep(1000);
    driver.findElement(By.xpath("//a[contains(@class,'filterGroup__button acid-btn acid-btn--outline-brand')]//i[contains(@class,'icon icon-arrow-right2')]")).click();
    Thread.sleep(1000);
    driver.findElement(By.xpath("//label[@for='checkbox0']")).click();
    ...
    Thread.sleep(1000);
 // Select Document Classification drop down
    WebElement ddown1 = driver.findElement(By.xpath("//select[@name='cust_2768']")); 
    Select SM1 = new Select(ddown1);
    SM1.selectByVisibleText("Certified True copy (to mandatory attached UTS )");
    
    Thread.sleep(1000);
    
    driver.findElement(By.xpath("//input[contains(@name,'cust_2766')]")).sendKeys("sample@gmail.com");
 ...
 // Record send to SMU DOCS Processor 	   
    
    driver.findElement(By.id("TxtName")).sendKeys("207241"); //loginid
 ...
 // Record send to SMU Supervisor    
    
    driver.findElement(By.id("TxtName")).sendKeys("201453"); //loginid
	driver.findElement(By.id("TxtPassword")).sendKeys("acid_qa"); //password
	driver.findElement(By.name("command")).click();// click enter
